...
import com.dicoding.picodiploma.netfilm.data.FilmDataSource;
import com.dicoding.picodiploma.netfilm.data.NetworkBoundResource;
...
public class FakeFilmRepository implements FilmDataSource {
    ...
    public FakeFilmRepository(RemoteDataSource remoteDataSource, LocalDataSource localDataSource, AppExecutors appExecutors) {
